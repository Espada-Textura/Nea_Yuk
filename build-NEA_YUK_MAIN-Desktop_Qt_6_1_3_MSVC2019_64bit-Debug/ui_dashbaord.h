/********************************************************************************
** Form generated from reading UI file 'dashbaord.ui'
**
...
#ifndef UI_DASHBAORD_H
#define UI_DASHBAORD_H
...
public:
    ...
    void setupUi(QWidget *dashbaord)
    {
        if (dashbaord->objectName().isEmpty())
            dashbaord->setObjectName(QString::fromUtf8("dashbaord"));
        dashbaord->resize(1700, 1030);
        frame_main = new QFrame(dashbaord);
...
"font-size: 12px;"));
        ...
        retranslateUi(dashbaord);

        QMetaObject::connectSlotsByName(dashbaord);
    } // setupUi

    void retranslateUi(QWidget *dashbaord)
    {
        dashbaord->setWindowTitle(QCoreApplication::translate("dashbaord", "Form", nullptr));
        main_titile->setText(QCoreApplication::translate("dashbaord", "Dashbaord", nullptr));
        main_titile_2->setText(QCoreApplication::translate("dashbaord", "Total", nullptr));
        main_titile_3->setText(QCoreApplication::translate("dashbaord", "1000", nullptr));
        main_titile_4->setText(QCoreApplication::translate("dashbaord", "200", nullptr));
        main_titile_5->setText(QCoreApplication::translate("dashbaord", "Showing", nullptr));
    } // retranslateUi

};

namespace Ui {
    class dashbaord: public Ui_dashbaord {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DASHBAORD_H
